...
enum ExampleType: Int, CaseIterable {
    ...
    var title: String {
        ...
        case .floatingPoint: return "10. 浮点运算"
        }
    }
}
...
class ExampleManager {
    ...
    private let floatingPointExample = FloatingPointExample()  // 添加浮点示例
    ...
    func runExample(_ type: ExampleType) async -> String {
        ...
        do {
            ...
            case .floatingPoint:
                return try floatingPointExample.run(emulator: emulator)
            }
        } catch {
